...
Installing Docker:
 ...
 > sudo gpasswd -a $USER docker ( adding all the other logged in nonroot users to the docker group)
 ...
 > docker run hello-world (Running the hello-world container, I am able to run it with my nonroot user so Docker seems to be installed        correctly)
