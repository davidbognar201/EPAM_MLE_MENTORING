...
test_data = pd.read_csv(filepath_or_buffer = r"/model/data/bike_rental_test_data.csv")
...
model = pickle.load(open(r"/model/trained_model/GradBoosting_Regressor_trained.sav", 'rb'))
